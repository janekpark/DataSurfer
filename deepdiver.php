...
if(isset($_POST['ajax_run'])){
    $_SESSION['total_population']=isset($_REQUEST['total_population'])?$_REQUEST['total_population']:"";
    $_SESSION['chart']=isset($_REQUEST['chart'])?$_REQUEST['chart']:"";
    $_SESSION['source_type']=isset($_REQUEST['source_type'])?$_REQUEST['source_type']:"";
    $_SESSION['year']=isset($_REQUEST['year'])?$_REQUEST['year']:"";
    $_SESSION['geography_type']=isset($_REQUEST['geography_type'])?$_REQUEST['geography_type']:"";
    $_SESSION['location']=isset($_REQUEST['location'])?$_REQUEST['location']:"";
    exit();
}
...
<body>
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-3">
											<dl>
												...
												<dd><span id="total_population"><?php echo $total_population;?></span></dd>
											</dl>
										</div>
									</div>
    ...
    <input type="hidden" id="deepdiver" value="<?php echo $chart_type;?>"/>
    <noscript>
